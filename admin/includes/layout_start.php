...
<link rel="stylesheet" href="/admin/assets/css/admin.css?v=20260127">
</head>
<body>
<div class="app-shell">
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      <a href="/admin/index.php" class="sidebar-link <?= nav_active('dashboard', $activeNav ?? '') ?>">
      ...
      <a href="/admin/calendar.php" class="sidebar-link <?= nav_active('calendar', $activeNav ?? '') ?>">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/></svg>
        Calendar
      </a>
      <a href="/admin/checkin.php" class="sidebar-link <?= nav_active('checkin', $activeNav ?? '') ?>">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>
        Front Desk Check-In
      </a>
      <a href="/admin/bookings.php" class="sidebar-link <?= nav_active('bookings', $activeNav ?? '') ?>">
      ...
      <a href="/admin/clients.php" class="sidebar-link <?= nav_active('clients', $activeNav ?? '') ?>">
      ...
      <a href="/admin/staff.php" class="sidebar-link <?= nav_active('staff', $activeNav ?? '') ?>">
      ...
      <a href="/admin/services.php" class="sidebar-link <?= nav_active('services', $activeNav ?? '') ?>">
      ...
      <a href="/admin/gallery.php" class="sidebar-link <?= nav_active('gallery', $activeNav ?? '') ?>">
      ...
      <a href="/admin/settings.php" class="sidebar-link <?= nav_active('settings', $activeNav ?? '') ?>">
    ...
    <div class="sidebar-footer">
      <div class="sidebar-user">
        ...
        <a href="/admin/logout.php" class="sidebar-logout" title="Sign out">
